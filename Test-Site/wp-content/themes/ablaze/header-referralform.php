...
7. Create functions.php file and add page thumbnails
...
console.info('checking for the CDR function');
	...
	<script src="http://pm.ablazeenergy.com/Accounts/1/Applications/V-4/Core/Scripts/JS/Number-Format-Masker.js"></script>
